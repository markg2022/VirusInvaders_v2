instance_create_layer(1748, 734, "hit", obj_hit1);
health -= 1; //decrease the health by 10
if (health <= 0) {
    with(Obj_Target3)instance_destroy(); //if health is less than or equal to 0, destroy the target
}

if (place_meeting(x, y, Obj_Target3)) {
